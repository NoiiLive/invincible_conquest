...
public class MenuAbilityPortalMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MenuAbilityPortalMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(InvincibleConquestModMenus.MENU_ABILITY_PORTAL.get(), id);
