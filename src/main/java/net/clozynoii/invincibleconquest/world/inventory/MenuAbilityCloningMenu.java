...
public class MenuAbilityCloningMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MenuAbilityCloningMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(InvincibleConquestModMenus.MENU_ABILITY_CLONING.get(), id);
