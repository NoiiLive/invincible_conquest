...
public class MenuAbilityBasicMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MenuAbilityBasicMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(InvincibleConquestModMenus.MENU_ABILITY_BASIC.get(), id);
