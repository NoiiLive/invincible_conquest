...
public class MenuAbilityAtomMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MenuAbilityAtomMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(InvincibleConquestModMenus.MENU_ABILITY_ATOM.get(), id);
