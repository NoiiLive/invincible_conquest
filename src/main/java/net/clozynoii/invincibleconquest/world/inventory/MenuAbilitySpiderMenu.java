...
public class MenuAbilitySpiderMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MenuAbilitySpiderMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(InvincibleConquestModMenus.MENU_ABILITY_SPIDER.get(), id);
