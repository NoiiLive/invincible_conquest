...
public class BarrierAbilityProcedure {
	public static void execute(Entity entity) {
		...
		if (!(entity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(InvincibleConquestModMobEffects.DELETED_MOD_ELEMENT))) {
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(InvincibleConquestModMobEffects.DELETED_MOD_ELEMENT, 99999, 0, false, false));
