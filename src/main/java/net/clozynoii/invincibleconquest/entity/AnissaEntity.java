...
public class AnissaEntity extends Monster implements GeoEntity {
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(InvincibleConquestModEntities.ANISSA.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return AnissaSpawnProcedure.execute(world, x, y, z);
