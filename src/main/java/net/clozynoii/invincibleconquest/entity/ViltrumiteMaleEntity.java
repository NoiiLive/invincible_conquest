...
public class ViltrumiteMaleEntity extends Monster implements GeoEntity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "viltrumite_male_black");
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, Player.class, false, false) {
			...
			public boolean canUse() {
				double x = ViltrumiteMaleEntity.this.getX();
				double y = ViltrumiteMaleEntity.this.getY();
				double z = ViltrumiteMaleEntity.this.getZ();
				Entity entity = ViltrumiteMaleEntity.this;
				Level world = ViltrumiteMaleEntity.this.level();
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
		...
		ViltrumiteMaleRandomProcedure.execute(this);
		return retval;
	}
