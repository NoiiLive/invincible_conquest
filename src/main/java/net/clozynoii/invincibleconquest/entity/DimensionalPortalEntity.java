...
import net.clozynoii.invincibleconquest.procedures.EnterDimensionalPortalProcedure;
import net.clozynoii.invincibleconquest.procedures.DimensionalPortalTickProcedure;
...
public class DimensionalPortalEntity extends TamableAnimal implements GeoEntity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "angstrom_portal");
		builder.define(DATA_TargetDimension, "");
		builder.define(DATA_DelayEnter, 20);
		builder.define(DATA_Despawn, 100);
		builder.define(DATA_Enters, 0);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		DimensionalPortalEntity retval = InvincibleConquestModEntities.DIMENSIONAL_PORTAL.get().create(serverWorld);
