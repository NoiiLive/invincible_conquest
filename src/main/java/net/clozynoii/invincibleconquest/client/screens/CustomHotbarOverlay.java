...
public class CustomHotbarOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (HideOverlayF1Procedure.execute()) {
			...
			event.getGuiGraphics().blit(ResourceLocation.parse("invincible_conquest:textures/screens/icons_sprite.png"), 12, 12, Mth.clamp((int) ReturnPlayerAbilityIconProcedure.execute(entity) * 16, 0, 160), 0, 16, 16, 176, 16);
